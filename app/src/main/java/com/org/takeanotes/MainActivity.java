...
import com.org.takeanotes.Authuser.Login;
import com.org.takeanotes.Authuser.Register;
import com.org.takeanotes.model.Note;
import com.org.takeanotes.note.AddNotes;
import com.org.takeanotes.note.EditNote;
import com.org.takeanotes.note.NoteDetail;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav_view = findViewById(R.id.nav_vew);
        ...
        FloatingActionButton fab = findViewById(R.id.addNote1);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(view.getContext(), AddNotes.class));
                overridePendingTransition(R.drawable.slide_up,R.drawable.slide_down);
                finish();
            }
        });
